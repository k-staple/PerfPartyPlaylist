    ...
    while (timeElapsedRuntime <= partyLength){
        ...
        if (!popular.empty()){
            if (favSongsPlayed == 2 && !unpopular.empty() ){
                ...
                cout << "Time elapsed: " << timeElapsedRuntime/60 << " minutes and " << timeElapsedRuntime %60 << " seconds " << "...NOW PLAYING: " << unpopularSong.title << "...of GENRE: " << unpopularSong.genre <<  endl;
                unpopular.pop();
                favSongsPlayed =0;
            ...
            cout << "Time elapsed: " << timeElapsedRuntime/60 << " minutes and " << timeElapsedRuntime %60 << " seconds " << "...NOW PLAYING: " << popularSong.title << "...of GENRE: " << popularSong.genre <<  endl;
            ...
            cout << "Time elapsed: " << timeElapsedRuntime/60 << " minutes and " << timeElapsedRuntime %60 << " seconds " << "...NOW PLAYING: " << playlist[backupIndex].title << "...of GENRE: " <<playlist[backupIndex].genre <<  endl;
            backupIndex++;
